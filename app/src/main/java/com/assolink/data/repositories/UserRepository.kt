            ...
            try {
                ...
                if (document.exists()) {
                    ...
                    val user = User(
                        ...
                        preferences = (data["preferences"] as? List<*>)?.filterIsInstance<String>() ?: emptyList(),
                        favoriteAssociations = (data["favoriteAssociations"] as? List<*>)?.filterIsInstance<String>() ?: emptyList(),
                        registeredEvents = (data["registeredEvents"] as? List<*>)?.filterIsInstance<String>() ?: emptyList()
                    )
                    Result.success(user)
                } else {
